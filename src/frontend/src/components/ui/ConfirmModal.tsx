...
import { Fragment, MouseEvent } from 'react'; // 1. Import MouseEvent
      ...
      <Dialog as="div" className="relative z-50" onClose={onClose} data-testid="confirm-modal-component">
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <DialogPanel
                className="w-full max-w-md transform overflow-hidden rounded-[2.5rem] bg-white p-8 text-left align-middle shadow-2xl transition-all"
              ...
              >
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
                  <Button
                    variant="outline"
                    onClick={(e) => {
                      e.stopPropagation(); // Double safety for the button specifically
                      onClose();
                    }}
                    className="h-12 border-slate-200 text-slate-600 sm:w-36"
